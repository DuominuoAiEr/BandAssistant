...
class ChatAPI {
    ...
    constructor(p_api_chat: String, p_api_key: String) {
...
class BotModel extends ChatAPI {
    ...
    constructor(p_api_chat: String, p_api_key: String, pm_name: String, pm_images: String, pm_model: String) {
        super(p_api_chat, p_api_key,);
        this.m_name = pm_name
...
class ChatHistory extends BotModel {
    ...
    constructor(p_api_chat: String, p_api_key: String, pm_name: String, pm_images: String, pm_model: String, p_history_uuid: String, p_history_name: String, p_history_last_content: String) {
        super(p_api_chat, p_api_key, pm_name, pm_images, pm_model);
...
class ChatBot extends ChatHistory {
    ...
    constructor(p_api_chat: String, p_api_key: String, pm_name: String, pm_images: String, pm_model: String, p_history_uuid: String, p_history_name: String, p_history_last_content: String) {
        super(p_api_chat, p_api_key, pm_name, pm_images, pm_model, p_history_uuid, p_history_name, p_history_last_content)
    }
